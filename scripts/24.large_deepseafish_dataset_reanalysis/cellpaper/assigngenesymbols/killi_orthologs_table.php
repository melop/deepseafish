...
//$sOut = "allfish_orthologs_table.ensemblinformed.txt"; #output
$sOut = "fewerfish_orthologs_table.ensemblinformed.txt";
$sOut = "BTP_orthologs_table.ensemblinformed.txt";
...
$arrSpecies = array( "anabas", "astyanax", "betta", "bonytongue", "BTP",  "Cheilinus_undulatus", "collichthys_lucidus",  "Datnioides_undecimradiatus",
"gadus", "larimichthys_crocea",  "Lutjanus_erythropterus", "medaka",  "Micropterus_salmoides",  "neogobius",  "nibea_albiflora",  "poecilia",  "salmon", "Sander_lucioperca",  "spotted_gar"
,"stickleback", "takifugu",  "tetraodon",  "tilapia" , "xmac",  "zebrafish" );

$arrSpecies = array( "anabas", "astyanax", "betta", "bonytongue", "BTP",  "Cheilinus_undulatus",  "Datnioides_undecimradiatus",
"gadus",   "Lutjanus_erythropterus", "medaka",  "Micropterus_salmoides",  "neogobius",  "poecilia",  "salmon", "Sander_lucioperca",  "spotted_gar"
,"stickleback", "takifugu",  "tetraodon",  "tilapia" , "xmac",  "zebrafish" );

$arrSpecies = array("BTP");
...
function fnParseGenes($s) {
	...
	foreach($arrF1 as $sGene) {
		...
		$arrF2 = explode("|" , $sGene);
		$sTaxon = trim($arrF2[0]);
		$sGeneId = trim($sGene); //trim($arrF2[1]);
